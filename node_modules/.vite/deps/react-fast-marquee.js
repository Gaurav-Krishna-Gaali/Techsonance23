...
var require_dist = __commonJS({
  "node_modules/react-fast-marquee/dist/index.js"(exports) {
    ...
    var Marquee = function(_a) {
      ...
      return React__default["default"].createElement(React.Fragment, null, !isMounted ? null : React__default["default"].createElement("div", { ref: containerRef, style: __assign(__assign({}, style), (_b = {}, _b["--pause-on-hover"] = pauseOnHover ? "paused" : "running", _b["--pause-on-click"] = pauseOnClick ? "paused" : "running", _b)), className: className + " marquee-container" }, gradient && React__default["default"].createElement("div", { style: (_c = {}, _c["--gradient-color"] = rgbaGradientColor + ", 1), " + rgbaGradientColor + ", 0)", _c["--gradient-width"] = typeof gradientWidth === "number" ? gradientWidth + "px" : gradientWidth, _c), className: "overlay" }), React__default["default"].createElement("div", { ref: marqueeRef, style: (_d = {}, _d["--play"] = play ? "running" : "paused", _d["--direction"] = direction === "left" ? "normal" : "reverse", _d["--duration"] = duration + "s", _d["--delay"] = delay + "s", _d["--iteration-count"] = !!loop ? "" + loop : "infinite", _d), className: "marquee", onAnimationIteration: onCycleComplete, onAnimationEnd: onFinish }, children), React__default["default"].createElement("div", { style: (_e = {}, _e["--play"] = play ? "running" : "paused", _e["--direction"] = direction === "left" ? "normal" : "reverse", _e["--duration"] = duration + "s", _e["--delay"] = delay + "s", _e["--iteration-count"] = !!loop ? "" + loop : "infinite", _e), className: "marquee" }, children)));
    };
    exports.default = Marquee;
  }
});

// dep:react-fast-marquee
var react_fast_marquee_default = require_dist();
export {
  react_fast_marquee_default as default
};
/*! *****************************************************************************
